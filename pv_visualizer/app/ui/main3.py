r"""
Version for trame 1.x - https://github.com/Kitware/trame/blob/release-v1/examples/ParaView/ContourGeometry/LocalRendering.py
...
data_directory = Path(__file__).parent.parent.parent.with_name("ParaView")
head_vti = data_directory / "vti" / "sample.vti"
